 ...
 const Formats = [
	...
	},
	{
		...
		banlist: [
			...
			'Necrozma-Mega', 'Palkia', 'Pheromosa', 'Rayquaza', 'Reshiram', 'Salamence-Mega', 'Shaymin-Sky', 'Solgaleo', 'Spectrier', 'Tornadus-Therian',
			...
			ignoringAbility() {
				...
				return !!(
					...
					((this.volatiles['gastroacid'] || (neutralizinggas &&
						this.ability !== ('neutralizinggas' ) && this.item !== ('neutralizinggas' ))) &&
