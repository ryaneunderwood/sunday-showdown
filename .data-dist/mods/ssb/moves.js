	...
	*/
	...
	broadsidebarrage: {
		...
		onPrepareHit(target, source) {
			...
			this.add(`c|${_conditions.getName.call(void 0, 'Archas')}|Fire all guns! Fiiiiire!`);
		},
	...
	radiantburst: {
		...
		onHit(target, pokemon) {
			this.add(`c|${_conditions.getName.call(void 0, 'Arcticblast')}|YEET`);
	...
	getoffmylawn: {
		...
		onHit() {
			this.add(`c|${_conditions.getName.call(void 0, 'drampa\'s grandpa')}|GET OFF MY LAWN!!!`);
		},
		secondary: null,
		forceSwitch: true,
		target: "normal",
	...
	youhavenohope: {
		...
		onHit(target, source) {
			this.add(`c|${_conditions.getName.call(void 0, 'explodingdaisies')}|You have no hope ${target.name}!`);
		},
		secondary: null,
		target: "normal",
		type: "Normal",
	...
	soupstealing7starstrikeredux: {
		...
		onHit(target, source) {
			...
			if (this.randomChance(1, 2)) {
				this.add(`c|${_conditions.getName.call(void 0, 'fart')}|I hl on soup`);
			} else {
				this.add(`c|${_conditions.getName.call(void 0, 'fart')}|I walk with purpose. bring me soup.`);
			}
		},
		condition: {
			duration: 2,
	...
	randomscreaming: {
		...
		secondary: {
			...
			status: 'frz',
			onHit() {
				this.add(`c|${_conditions.getName.call(void 0, 'Gimmick')}|Show me some more paaain, baaaby`);
			},
		},
		thawsTarget: true,
		target: "normal",
	...
	gacha: {
		...
		onHit(target, source, move) {
			...
			if (message) this.add(`c|${_conditions.getName.call(void 0, 'GMars')}|${message}`);
	...
	thehuntison: {
		...
		onAfterMoveSecondarySelf(pokemon, target, move) {
			if (!target || target.fainted || target.hp <= 0) {
				this.add(`c|${_conditions.getName.call(void 0, 'Jett')}|Owned!`);
			}
		},
		condition: {
			duration: 1,
	...
	spamguess: {
		...
		onHit(target, source) {
			for (const move of ['Haze', 'Worry Seed', 'Poison Powder', 'Stun Spore', 'Leech Seed']) {
				...
				this.add(`c|${_conditions.getName.call(void 0, 'Meicoo')}|That is not the answer - try again!`);
			}
	...
	technotubertransmission: {
		...
		onHit() {
			this.add(`c|${_conditions.getName.call(void 0, 'Notater517')}|/html For more phantasmic music, check out <a href = "http://spo.ink/tunes">this link.</a>`);
		},
		self: {
	...
	omzoom: {
		...
		onHit() {
			this.add(`c|${_conditions.getName.call(void 0, 'OM~!')}|Bang Bang`);
		},
		flags: {protect: 1, mirror: 1},
		selfSwitch: true,
		secondary: null,
	...
	balefulblaze: {
		...
		onAfterMoveSecondarySelf(pokemon, target, move) {
			if (!target || target.fainted || target.hp <= 0) {
				this.add(`c|${_conditions.getName.call(void 0, 'PartMan')}|FOR SNOM!`);
	...
	trickery: {
		...
		onHit(target, source, effect) {
			this.add(`c|${_conditions.getName.call(void 0, 'Perish Song')}|/html <img src="https://i.imgflip.com/3rt1d8.png" width="262" height="150" />`);
			const item = target.takeItem(source);
			if (!target.item) {
	...
	dungeonsdragons: {
		...
		onHit(target, source, move) {
			this.add(`c|${_conditions.getName.call(void 0, 'PiraTe Princess')}|did someone say d&d?`);
	...
	stonykibbles: {
		...
		onHit() {
			this.add(`c|${_conditions.getName.call(void 0, 'Raihan Kibana')}|Let the winds blow! Stream forward, Sandstorm!`);
		},
		onPrepareHit(target, source) {
			this.add('-anim', source, 'Rock Slide', target);
	...
	homunculussvanity: {
		...
		self: {
			onHit(source) {
				...
				this.add(`c|${_conditions.getName.call(void 0, 'Sectonia')}|Jelly baby ;w;`);
			},
		},
		secondary: null,
		target: "self",
	...
	tsukuyomi: {
		...
		onHit(pokemon, source, move) {
			this.add(`c|${_conditions.getName.call(void 0, 'Segmr')}|I don't like naruto actually let someone else write this message plz.`);
	...
	badopinion: {
		...
		onHit() {
			this.add(`c|${_conditions.getName.call(void 0, 'sejesensei')}|Please go read To Love-Ru I swear its really good, wait... don’t leave…`);
		},
		self: {
			boosts: {
				def: 1,
	...
	legendaryswordsman: {
		...
		onTry(source, target) {
			...
			if (!move || (move.category === 'Status' && move.id !== 'mefirst') || target.volatiles['mustrecharge']) {
				if (_optionalChain([move, 'optionalAccess', _33 => _33.category]) === 'Status') {
					this.add(`c|${_conditions.getName.call(void 0, 'Seso')}|Irritating a better swordsman than yourself is always a good way to end up dead.`);
				} else {
					this.add(`c|${_conditions.getName.call(void 0, 'Seso')}|Scars on the back are a swordsman's shame.`);
				}
				return false;
			}
		},
		...
		onPrepareHit(target, source) {
			this.add(`c|${_conditions.getName.call(void 0, 'Seso')}|FORWARD!`);
	...
	veto: {
		...
		onHit(target, source) {
			if (source.m.statsRaisedLastTurn) {
				this.add(`c|${_conditions.getName.call(void 0, 'Struchni')}|**veto**`);
			}
		},
		target: "normal",
		type: "Steel",
	...
	rightoncue: {
		...
		onHit(target, source) {
			...
			if (successes === 1) {
				this.add(`c|${_conditions.getName.call(void 0, 'tiki')}|truly a dumpster fire`);
			} else if (successes >= 4) {
				this.add(`c|${_conditions.getName.call(void 0, 'tiki')}|whos ${source.side.foe.name}?`);
			}
		},
		secondary: null,
		target: "self",
	...
	glitchexploiting: {
		...
		onHit(target, source, move) {
			...
			if (random === 1) {
				...
				this.add(`c|${_conditions.getName.call(void 0, 'Volco')}|haha memory corruption go brrr...`);
		...
		secondaries: [
			{
				...
				onHit(target, source) {
					...
					this.add(`c|${_conditions.getName.call(void 0, 'Volco')}|Ever just screw up the trick and corrupt the memory and cause the wrong thing to happen possibly ruining a run? No? Just me? okay...`);
					if (this.randomChance(1, 2)) {
	...
	ingredientforaging: {
		...
		onAfterHit(target, source) {
			...
			if (source.hp && target.takeItem(source)) {
				...
				this.add(`c|${_conditions.getName.call(void 0, 'Zalm')}|Yum`);
	...
	bigstormcoming: {
		...
		onPrepareHit() {
			this.add(`c|${_conditions.getName.call(void 0, 'Zodiax')}|There is a hail no storm okayyyyyy`);
		},
		onTry(pokemon, target) {
