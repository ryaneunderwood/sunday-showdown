...
var _iptools = require('./ip-tools');
 ...
 class ServerStream extends _lib.Streams.ObjectReadWriteStream {
	...
	__init5() {this.receivers = {
		...
		':'(data) {
			...
			for (const [curSocketid, curSocket] of room) {
				const channelid = _optionalChain([roomChannel, 'optionalAccess', _3 => _3.get, 'call', _4 => _4(curSocketid)]) || 0;
	...
	constructor(config
		...
		super();ServerStream.prototype.__init.call(this);ServerStream.prototype.__init2.call(this);ServerStream.prototype.__init3.call(this);ServerStream.prototype.__init4.call(this);ServerStream.prototype.__init5.call(this);;
